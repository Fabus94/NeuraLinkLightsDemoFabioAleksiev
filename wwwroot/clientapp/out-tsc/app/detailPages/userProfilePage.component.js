...
var userProfilePage = /** @class */ (function () {
    function userProfilePage(data, router, sanitizer, countdownService) {
        this.data = data;
        this.router = router;
    ...
    userProfilePage.prototype.ngOnInit = function () {
        ...
        this.DelayResponceCtrl.valueChanges
            ...
            .subscribe(function (myControl) { return _this.updateExplore.document = _this.data.fileuri.primaryUri; });
    };
    ...
    userProfilePage.prototype.CheckWORD = function (check) {
    ...
    userProfilePage.prototype.CheckReleaseUpload = function () {
            ...
            this.data.uploadFile(formData, blobDstnt)
                ...
                if (success) {
                    ...
                    if (_this.CheckWORD(_this.selectedFiles.name)) {
                        _this.updateExplore.document = _this.data.holdImagePostDoc;
