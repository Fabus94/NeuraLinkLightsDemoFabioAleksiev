...
var ExploreList = /** @class */ (function () {
    function ExploreList(data, router, sanitizer, countdownService) {
        this.data = data;
        this.router = router;
    ...
    ExploreList.prototype.SearchHashTag = function (val) {
        this.display = val;
    };
    ...
    ExploreList.prototype.CheckReleaseUpload = function () {
