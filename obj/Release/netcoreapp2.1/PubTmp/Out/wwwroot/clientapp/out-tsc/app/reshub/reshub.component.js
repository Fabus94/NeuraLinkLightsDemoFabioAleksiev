...
var Reshub = /** @class */ (function () {
    ...
    Reshub.prototype.CheckNewConverstions = function () {
        for (var _i = 0, _a = this.data.conversations; _i < _a.length; _i++) {
            var value = _a[_i];
            if (value.openedread == 1 && value.recipientRef == this.data.currentUser.id && value.issuerRef != this.data.currentUser.id) {
                return true;
            }
        }
    };
    ...
    Reshub.prototype.PostCircle = function () {
        var _this = this;
        if (this.data.currentUser.id > 0) {
            this.data.loadListsInvites(this.data.currentUser)
                .subscribe(function (success) {
                if (success) {
                }
