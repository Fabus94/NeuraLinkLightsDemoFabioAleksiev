...
var ProjectsFromMembers = /** @class */ (function () {
    ...
    ProjectsFromMembers.prototype.ngOnInit = function () {
        ...
        this.DelayResponceCtrl.valueChanges
            ...
            .subscribe(function (myControl) { return _this.projectstoUpdate.document = _this.data.fileuri.primaryUri; });
    };
    ...
    ProjectsFromMembers.prototype.CheckWORD = function (check) {
    ...
    ProjectsFromMembers.prototype.CheckReleaseUpload = function () {
            ...
            this.data.uploadFile(formData, blobDstnt)
                ...
                if (success) {
                    ...
                    if (_this.CheckWORD(_this.selectedFiles.name)) {
                        _this.projectstoUpdate.document = _this.data.holdImagePostDoc;
